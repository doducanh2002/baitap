package com.aibles.springjwt.security;

import com.aibles.springjwt.security.jwt.AuthEntryPointJwt;
import com.aibles.springjwt.security.jwt.AuthTokenFilter;
...
@EnableGlobalMethodSecurity(prePostEnabled = true)//cung cấp bảo mật Aop
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http.cors().and().csrf().disable()
      ...
      .anyRequest().authenticated();//tatar cả request đều cần truy cập
